...
以实际代码和 Git 状态为准。如果文档与代码不一致，先修正文档。按照 current-status 的“下一步明确动作”继续开发，关键动作后立即更新 current-status 和 work-log。允许创建本地里程碑提交，但未经我明确说“同意推送”，禁止 git push、远端分支、标签、发布或合并到远端 main。
